...
public class AdminSignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(signin, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 228, -1, 40));
        ...
        getContentPane().add(signin1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 430, 100, 40));
    ...
    private void signin1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signin1MouseClicked
        if("Enter username".equals(username.getText()) || "Enter password".equals(password.getText()) || username.getText().isEmpty() || password.getText().isEmpty()){
            ...
            admin.insertRecord(admin.createRecordFrom(username.getText()+","+password.getText()));
            admin.saveToFile();
